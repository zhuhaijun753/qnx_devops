...
int main(int argc, char *argv[])
{
	...
	if (!(in32(base + SWT_CR) & SWT_CR_WEN ))
	{
	...
	while (1) {
		out32(base + SWT_SR, WDT_SEQ1);
		out32(base + SWT_SR, WDT_SEQ2);
		delay(time);
	}
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/support/s32v-wdtkick/main.c $ $Rev: 886103 $")
#endif
