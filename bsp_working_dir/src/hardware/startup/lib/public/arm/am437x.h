/*
 * $QNXLicenseC:
 * Copyright 2015,2019, QNX Software Systems.
 *
...
#define AM437X_CM_DEVICE_BASE      (AM437X_PRCM_BASE + CM_DEVICE)
...
#define AM437X_CM_WKUP_BASE        (AM437X_PRCM_BASE + CM_WKUP)
...
#define PRM_DEVICE_BASE            (AM437X_PRCM_BASE + PRM_DEVICE)
...
#define CM_PER_BASE                (AM437X_PRCM_BASE + CM_PER)
...
#define AM437X_CM_PER_PWMSS0_CLKCTRL       (CM_PER_BASE + 0x438)
    #define AM437X_CM_PER_PWMSSX_CLKCTRL_MODULEMODE_MASK    (0x3)
    #define AM437X_CM_PER_PWMSSX_CLKCTRL_MODULEMODE_DISABLE (0)
    #define AM437X_CM_PER_PWMSSX_CLKCTRL_MODULEMODE_ENABLE  (2)
...
#define CM_DPLL_BASE               (AM437X_PRCM_BASE + CM_DPLL)
...
#define AM437X_TPCC_EVT_MUX_0_3            (0xF90)
#define AM437X_TPCC_EVT_MUX_4_7            (0xF94)
#define AM437X_TPCC_EVT_MUX_8_11           (0xF98)
#define AM437X_TPCC_EVT_MUX_12_15          (0xF9C)
#define AM437X_TPCC_EVT_MUX_16_19          (0xFA0)
#define AM437X_TPCC_EVT_MUX_20_23          (0xFA4)
#define AM437X_TPCC_EVT_MUX_24_27          (0xFA8)
#define AM437X_TPCC_EVT_MUX_28_31          (0xFAC)
#define AM437X_TPCC_EVT_MUX_32_35          (0xFB0)
#define AM437X_TPCC_EVT_MUX_36_39          (0xFB4)
#define AM437X_TPCC_EVT_MUX_40_43          (0xFB8)
#define AM437X_TPCC_EVT_MUX_44_47          (0xFBC)
#define AM437X_TPCC_EVT_MUX_48_51          (0xFC0)
#define AM437X_TPCC_EVT_MUX_52_55          (0xFC4)
#define AM437X_TPCC_EVT_MUX_56_59          (0xFC8)
#define AM437X_TPCC_EVT_MUX_60_63          (0xFCC)
...
#define AM437X_CTRL_PWMSS                   (AM437X_CTRL_BASE + 0x664)

#define PWMSS0_TBCLKEN                     (1 << 0)
#define PWMSS1_TBCLKEN                     (1 << 1)
#define PWMSS2_TBCLKEN                     (1 << 2)
#define PWM_SYNCSEL                        (1 << 3)
#define PWMSS3_TBCLKEN                     (1 << 4)
#define PWMSS4_TBCLKEN                     (1 << 5)
#define PWMSS5_TBCLKEN                     (1 << 6)

#define AM437X_NUM_PWMS                    (6)
...
#define AM437X_PWMSS_SIZE                 0x260
    ...
    #define PWMSS_EPWM_TBCTL              0x200
    #define PWMSS_EPWM_TBSTS              0x202
    #define PWMSS_EPWM_TBPHSHR            0x204
    #define PWMSS_EPWM_TBPHS              0x206
    #define PWMSS_EPWM_TBCNT              0x208
    #define PWMSS_EPWM_TBPRD              0x20A
    #define PWMSS_EPWM_CMPCTL             0x20E
    #define PWMSS_EPWM_CMPAHR             0x210
    #define PWMSS_EPWM_CMPA               0x212
    #define PWMSS_EPWM_CMPB               0x214
    #define PWMSS_EPWM_AQCTLA             0x216
    #define PWMSS_EPWM_AQCTLB             0x218
    #define PWMSS_EPWM_AQSFRC             0x21A
    #define PWMSS_EPWM_AQCSFRC            0x21C
    #define PWMSS_EPWM_DBCTL              0x21E
    #define PWMSS_EPWM_DBRED              0x220
    #define PWMSS_EPWM_DBFED              0x222
    #define PWMSS_EPWM_TZSEL              0x224
    #define PWMSS_EPWM_TZCTL              0x228
    #define PWMSS_EPWM_TZEINT             0x22A
    #define PWMSS_EPWM_TZFLG              0x22C
    #define PWMSS_EPWM_TZCLR              0x22E
    #define PWMSS_EPWM_TZFRC              0x230
    #define PWMSS_EPWM_ETSEL              0x232
    #define PWMSS_EPWM_ETPS               0x234
    #define PWMSS_EPWM_ETFLG              0x236
    #define PWMSS_EPWM_ETCLR              0x238
    #define PWMSS_EPWM_ETFRC              0x23A
    #define PWMSS_EPWM_PCCTL              0x23C
    #define PWMSS_EPWM_HRCTL              0x2C0
...
#ifdef __ASM__
__SRCVERSION "$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/startup/lib/public/arm/am437x.h $ $Rev: 896103 $"
#else
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/startup/lib/public/arm/am437x.h $ $Rev: 896103 $" )
#endif
#endif
