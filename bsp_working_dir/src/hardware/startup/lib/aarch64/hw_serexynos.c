...
/*
 * Samsung Exynos polled serial operations
 */
 ...
 */
void
init_exynos(unsigned channel, const char *init, const char *defaults)
{
	paddr_t		base;
	unsigned	baud;
	unsigned	clk;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/startup/lib/aarch64/hw_serexynos.c $ $Rev: 888192 $")
#endif
