...
gic_v3_init(paddr_t gicd, paddr_t gicr, paddr_t gicc, unsigned const nlpi, int use_mm) {
    ...
    if(gicd_typer & GICD_TYPER_SecurityExtn) {
        ...
        // TODO: I don't know why ARM_GICD_CTLR_ARE_NS is not set
        ...
        out32(gicd + ARM_GICD_CTLR,
                GICD_CTLR_ARE_1s| GICD_CTLR_ENABLEGRP1_1s | GICD_CTLR_ENABLEGRP0_1s);
    }
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/startup/lib/aarch64/gic_v3.c $ $Rev: 886103 $")
#endif
