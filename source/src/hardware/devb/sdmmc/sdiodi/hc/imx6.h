...
#define	IMX6_SDHCX_SYSCTL			0x2C	// Clock Control/Timeout/Software reset
	...
	#define	IMX6_SDHCX_SYSCTL_IPP_RST_N		(1 << 23)	// CARD reset_n output pin
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/devb/sdmmc/sdiodi/hc/imx6.h $ $Rev: 886103 $")
#endif
