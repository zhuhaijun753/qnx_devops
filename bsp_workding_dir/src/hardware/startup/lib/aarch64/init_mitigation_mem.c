...
void init_mitigation_mem(void)
{
        ...
        */
        ...
        //	2019-04-02
        //	This needs to be removed when aarch64/syspage.h is merged from mainline to 700.
        //	It is defined here to allow br-700_be-700 BSPs to be built against 700 header.
...
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/startup/lib/aarch64/init_mitigation_mem.c $ $Rev: 886103 $" )
#endif
