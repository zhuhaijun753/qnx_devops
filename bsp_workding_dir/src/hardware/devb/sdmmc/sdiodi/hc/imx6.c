...
static int imx6_sdhcx_clk( sdio_hc_t *hc, int clk )
{
	...
	sctl = ((0xE << IMX6_SDHCX_SYSCTL_DTO_SHIFT) |
		...
		(div << IMX6_SDHCX_SYSCTL_DVS_SHIFT) | 0xF | (sctl & IMX6_SDHCX_SYSCTL_IPP_RST_N));
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/devb/sdmmc/sdiodi/hc/imx6.c $ $Rev: 886103 $")
#endif
