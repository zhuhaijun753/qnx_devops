...
int imx_sdhcx_reg_dump(sdio_hc_t *hc, const char *func, int line)
{
    imx_sdhcx_hc_t     *sdhc;
    uintptr_t           base;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/devb/sdmmc/sdiodi/hc/imx8_hc.c $ $Rev: 906128 $")
#endif
