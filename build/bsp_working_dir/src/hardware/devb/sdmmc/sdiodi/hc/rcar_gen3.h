...
#define SDH_INFO2_DATA_ERR      (SDH_INFO2_ENDE | SDH_INFO2_DTO | SDH_INFO2_BIWA | SDH_INFO2_BIRA)
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/devb/sdmmc/sdiodi/hc/rcar_gen3.h $ $Rev: 903416 $")
#endif
