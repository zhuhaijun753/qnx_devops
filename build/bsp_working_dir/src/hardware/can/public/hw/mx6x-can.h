...
#define RINGO_CANESR2             0x38
#define RINGO_CANCRCR             0x44
#define RINGO_CANRXFGMASK         0x48
#define RINGO_CANRXFIR            0x4C
#define RINGO_CANCBT              0x50
#define RINGO_CANIMASK4           0x68
#define RINGO_CANIMASK3           0x6C
#define RINGO_CANIFLAG4           0x70
#define RINGO_CANIFLAG3           0x74
...
typedef struct candev_ringo_init_entry
{
    ...
    paddr_t          mem;          /* CAN Message Object Physical Memory Address */
...
typedef struct candev_ringo_info_entry
{
    ...
    int                             iidsys1;    /* Return iid from InterruptAttach */
    int                             iidsys2;    /* Return iid from InterruptAttach */
    uint32_t                        numtx;      /* Number of TX Mailboxes */
    uint32_t                        numrx;      /* Number of RX Mailboxes */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/can/public/hw/mx6x-can.h $ $Rev: 905826 $")
#endif
