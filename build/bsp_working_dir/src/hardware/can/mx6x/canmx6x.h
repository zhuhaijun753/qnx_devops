...
/*
 * Note: ARM platforms running >= 6.6.0 and AARCH64 need to execute at a lower privilege level
 *       CAN registers are otherwise inaccessible (bus error).
 */
#if (defined(__ARM__) || defined(__aarch64__)) && defined(_NTO_TCTL_IO_PRIV)
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/can/mx6x/canmx6x.h $ $Rev: 905826 $")
#endif
