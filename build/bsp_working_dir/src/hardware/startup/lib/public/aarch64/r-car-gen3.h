...
#define RCAR_GEN3_SYSC_BASE              0xE6180000
 ...
 #define RCAR_GEN3_SYSC_PWRSRx(_x)       (RCAR_GEN3_SYSC_PWRSR0 + ((_x) * 0x40)        + ((_x) > 7 ? 0xC0 : 0x0))
 #define RCAR_GEN3_SYSC_PWROFFCRx(_x)    (RCAR_GEN3_SYSC_PWRSR0 + ((_x) * 0x40) + 0x4  + ((_x) > 7 ? 0xC0 : 0x0))
 #define RCAR_GEN3_SYSC_PWROFFSRx(_x)    (RCAR_GEN3_SYSC_PWRSR0 + ((_x) * 0x40) + 0x8  + ((_x) > 7 ? 0xC0 : 0x0))
 #define RCAR_GEN3_SYSC_PWRONCRx(_x)     (RCAR_GEN3_SYSC_PWRSR0 + ((_x) * 0x40) + 0xC  + ((_x) > 7 ? 0xC0 : 0x0))
 #define RCAR_GEN3_SYSC_PWRONSRx(_x)     (RCAR_GEN3_SYSC_PWRSR0 + ((_x) * 0x40) + 0x10 + ((_x) > 7 ? 0xC0 : 0x0))
 #define RCAR_GEN3_SYSC_PWRERx(_x)       (RCAR_GEN3_SYSC_PWRSR0 + ((_x) * 0x40) + 0x14 + ((_x) > 7 ? 0xC0 : 0x0))
...
#ifdef __ASM__
__SRCVERSION "$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/startup/lib/public/aarch64/r-car-gen3.h $ $Rev: 903969 $"
#else
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/startup/lib/public/aarch64/r-car-gen3.h $ $Rev: 903969 $" )
#endif
#endif
